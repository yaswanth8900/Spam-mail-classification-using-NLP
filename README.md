...
<!-- THE DATASET -->
## <br>**➲ The Dataset**
Human activities dataset contain about 5728 record which is a sample of an email
...
1. Clone the repo
   ```sh
   git clone https://github.com/yaswanth8900/Spam-Email-Classification-using-NLP-and-Machine-Learning-.git
   ```
...
<!-- CONTACT -->
## <br>**➲ Contact**
- E-mail   : [chyaswanth890@gmail.com](mailto:chyaswanth890@gmail.com)
-